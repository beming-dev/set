...
export default function Selling() {
  const steps = [
    "Create an account and post your announcement",
    "Use the filters and prompts to screen and speed up your matching process",
    "Connect and reach out with the investor. Good feeling? Setup a meeting!",
  ...
  return (
    <div className="selling">
      <div className="content-01">
        <span className="title">Selling your company?</span>
        <span className="text-01">
          Find the <u>ideal</u> buyer quickly
        </span>
      ...
      <div className="content-03">
        <div className="price-chart-box">
          <Image src="/images/price-chart.png" alt="price-chart" fill />
        </div>
      </div>
      <div className="content-04">
        ...
        <div className="button-box">
          <button className="btn-sell">Selling a company: Blog</button>
          <button className="btn-sell">Free company valuation</button>
        </div>
      </div>
      <style jsx>
        {`
